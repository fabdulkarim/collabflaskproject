...
class MergeResource(Resource):
    ...
    def merge(input_file, texts, author):
        ...
        # # image=Image.open((open(input_file, 'rb')))
        ...
        # font2 = ImageFont.truetype(font_use, size=font_size+1)
        # font_author=ImageFont.truetype(font_use, size=font_size-20)
        # font_author2=ImageFont.truetype(font_use, size=font_size-19)
        ...
        # # return image.show()
        # # #return 
        # image.save('quotes.jpg')
        # #return uploads('quotes.jpg')
    ...
    def uploads(fileto):
        ...
        #with open('out2.json', 'w') as source:
